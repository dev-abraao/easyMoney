            ...
            <div class="max-w-lg relative z-10">
                ...
                <div class="space-y-5">
                    <div class="group flex items-start space-x-4 p-4 rounded-xl bg-gray-700/30 border border-gray-700/50 hover:border-green-500/50 transition-all duration-300 hover:bg-gray-700/50">
                        ...
                        <div>
                            <h3 class="text-white font-semibold mb-1">Track Expenses Effortlessly</h3>
                            <p class="text-gray-400 text-sm">Monitor every transaction with ease</p>
                        </div>
                    </div>
                    ...
                    <div class="group flex items-start space-x-4 p-4 rounded-xl bg-gray-700/30 border border-gray-700/50 hover:border-green-500/50 transition-all duration-300 hover:bg-gray-700/50">
                        ...
                        <div>
                            <h3 class="text-white font-semibold mb-1">Recurring Transactions</h3>
                            <p class="text-gray-400 text-sm">Automate your regular expenses</p>
                        </div>
                    </div>
                    ...
                    <div class="group flex items-start space-x-4 p-4 rounded-xl bg-gray-700/30 border border-gray-700/50 hover:border-green-500/50 transition-all duration-300 hover:bg-gray-700/50">
                        ...
                        <div>
                            <h3 class="text-white font-semibold mb-1">Financial Goals</h3>
                            <p class="text-gray-400 text-sm">Set and achieve your targets</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-3 gap-4 mt-10 pt-10 border-t border-gray-700/50">
                    <div class="text-center">
                        ...
                        <div class="text-xs text-gray-400 uppercase tracking-wide">Free</div>
                    </div>
                    <div class="text-center">
                        <div class="text-3xl font-bold text-blue-400 mb-1">24/7</div>
                        <div class="text-xs text-gray-400 uppercase tracking-wide">Access</div>
                    </div>
                    <div class="text-center">
                        <div class="text-3xl font-bold text-purple-400 mb-1">Secure</div>
                        <div class="text-xs text-gray-400 uppercase tracking-wide">Data</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="w-full max-w-md relative z-10">
                ...
                <div class="bg-gradient-to-br from-gray-800 to-gray-850 rounded-2xl shadow-2xl p-8 border border-gray-700 backdrop-blur-sm">
                    <div class="text-center mb-8">
                        <h2 class="text-3xl font-bold text-white mb-2 font-oswald">Welcome Back</h2>
