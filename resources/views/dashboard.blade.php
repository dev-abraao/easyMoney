...
<div class="flex flex-row">
    ...
    <div class="flex flex-col w-1/3 overflow-y-auto h-dvh scroll-smooth overscroll-contain custom-scrollbar bg-gray-900">
        <div class="sticky top-0 bg-gray-900 z-10 p-4 border-b border-gray-700">
            <h2 class="text-xl font-bold text-green-400 text-center font-oswald">Latest Payments</h2>
        </div>

        <div class="flex flex-col gap-3 p-4 flex-1">
            @forelse ($payments as $payment)
                <x-payment-card :payment="$payment" class="w-full"/>
            @empty
                <div class="flex flex-col items-center justify-center py-12 text-center">
                    <div class="w-16 h-16 bg-gray-800 rounded-full flex items-center justify-center mb-4">
                        <svg class="w-8 h-8 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p class="text-gray-400 text-lg mb-2">No payments yet</p>
                    <p class="text-gray-500 text-sm">Start tracking your payments by adding one!</p>
                </div>
            @endforelse
        </div>
